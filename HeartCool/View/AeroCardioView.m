...
static NSInteger kMaxContainerCapacity = 300;
...
{
    for (int i = 0; i < self.numberOfRefreshElements; i ++) {
        self.refreshPointContainer[i].x += offset;
    }
}

@end

@interface AeroCardioView ()
